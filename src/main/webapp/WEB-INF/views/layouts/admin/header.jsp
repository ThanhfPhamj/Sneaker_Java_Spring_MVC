	...
	<ul class="navbar-nav ml-auto">
				...
				<a class="dropdown-item d-flex align-items-center" href="#">
					...
					<div>
						<div class="text-truncate">Last month's report looks great,
							I am very happy with the progress so far, keep up the good work!
						</div>
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">Xin Chào
					Quản Trị Viên</span> <img class="img-profile rounded-circle"
			...
			<div
				...
				<a class="dropdown-item" href="@Url.Action("
					Index","Home")" data-toggle="modal" data-target="#logoutModal">
